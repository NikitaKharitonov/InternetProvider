...
//        LinkedList<User.UserService> userServices = user.getHistory(serviceType);
//        for (User.UserService userService : userServices) {
//            try {
//                nodes.add(new Label(controller.getService(userService.getServiceId()).getName()));
//                nodes.add(new Label(userService.getActivationDate().toString()));
//                nodes.add(new Label("————————————"));
